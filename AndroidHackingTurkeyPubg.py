...
tlg = requests.post(f'https://api.telegram.org/bot{token}/sendMessage?chat_id={id}&text=✅Tamamlandı : Developer > @AndroidHackingTurkey ✅ ')

exit('AndroidHackingTurkey')